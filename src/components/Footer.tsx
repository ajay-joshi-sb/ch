        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="mb-6 flex items-center">
              ...
              />
              <a href="#" className="text-2xl font-display font-semibold">PipelineGenerator</a>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-300">contact@pipelinegenerator.com</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                <MapPin className="w-5 h-5 text-brand-400 mr-3" />
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} PipelineGenerator. All rights reserved.
            </p>
