...
const PricingCalculator = () => {
  ...
  const calculateResults = () => {
    ...
    const missedCallsPerMonth = Math.round(inputs.monthlyCallVolume * (MISSED_CALL_RATE / 100));
    ...
    const addedMonthlyRevenue = Math.round(convertedCalls * inputs.averageTicketValue);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="flex flex-col h-full">
            <div className="flex items-center gap-2 mb-4 pb-2 border-b border-slate-700/50">
              ...
              <h3 className="text-lg font-bold text-white">Business Parameters</h3>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-sm font-medium text-gray-300">Monthly Call Volume</label>
                    <div className="text-blue-500 font-medium">{inputs.monthlyCallVolume} calls</div>
                  </div>
                  <input
                    type="range"
                    min="50"
                    ...
                    onChange={(e) => setInputs(prev => ({ ...prev, monthlyCallVolume: parseInt(e.target.value) }))}
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-sm font-medium text-gray-300">Average Ticket Value</label>
                    <div className="text-blue-500 font-medium">${inputs.averageTicketValue}</div>
                  </div>
                  <input
                    type="range"
                    min="100"
                    ...
                    onChange={(e) => setInputs(prev => ({ ...prev, averageTicketValue: parseInt(e.target.value) }))}
                    className="w-full h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-blue-500"
                  />
                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                    <span>$100</span>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-sm font-medium text-gray-300">Current Monthly Cost</label>
                    <div className="text-blue-500 font-medium">${inputs.currentCallCenterCost}</div>
                  </div>
                  <input
                    type="range"
                    min="0"
                    ...
                    onChange={(e) => setInputs(prev => ({ ...prev, currentCallCenterCost: parseInt(e.target.value) }))}
                    className="w-full h-2 bg-slate-700 rounded-lg appearance-none cursor-pointer accent-blue-500"
                  />
                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                    <span>$0</span>
              ...
              <div className="mt-4 p-3 bg-blue-900/20 rounded-lg border border-blue-700/30">
                <div className="flex items-center text-xs text-gray-300">
                  ...
                  Based on <span className="text-blue-400 font-medium mx-1">20% missed calls</span> and
                  <span className="text-blue-400 font-medium mx-1">30% conversion rate</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col h-full lg:border-l lg:border-slate-700/50 lg:pl-5">
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
                <h4 className="text-base font-medium text-white">Total Monthly Benefit</h4>
                ...
                <div className="bg-blue-900/20 rounded-lg p-3 mt-3 border border-blue-700/30">
                  <div className="flex justify-between items-center">
                    <h5 className="text-sm font-medium text-white">Annual Impact</h5>
