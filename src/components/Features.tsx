...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
  <div className="glass-card p-5 rounded-xl h-full reveal-on-scroll transition-all duration-500 opacity-0 transform translate-y-8 hover:translate-y-0 hover:shadow-glow-sm group border border-brand-700/20 hover:border-brand-500/30">
    ...
    <h3 className="text-lg font-display font-semibold mb-3 text-white text-center group-hover:text-brand-400 transition-colors duration-300">
      {title}
    </h3>
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto relative z-10 max-w-5xl">
        <div className="max-w-2xl mx-auto text-center mb-16">
          ...
          <h2 className="text-2xl md:text-4xl font-display font-bold mb-5 text-balance reveal-on-scroll text-white leading-tight">
            ...
            <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-brand-400 via-brand-500 to-brand-600">
              Convert More Calls
            </span>
          </h2>
          <p className="text-base text-gray-300 max-w-lg mx-auto reveal-on-scroll leading-relaxed">
            Our inbound call handling solution is designed for plumbers, HVAC
            technicians, roofers, electricians, and franchises to convert more
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-5 mb-16 px-2 md:px-6">
          <FeatureCard
            icon={
              <PhoneCall className="h-5 w-5 text-brand-500 group-hover:text-brand-400" />
            }
          ...
          <FeatureCard
            icon={
              <Calendar className="h-5 w-5 text-brand-500 group-hover:text-brand-400" />
            }
          ...
          <FeatureCard
            icon={
              <Plug className="h-5 w-5 text-brand-500 group-hover:text-brand-400" />
            }
          ...
          <FeatureCard
            icon={
              <Bolt className="h-5 w-5 text-brand-500 group-hover:text-brand-400" />
            }
          ...
          <FeatureCard
            icon={
              <Bot className="h-5 w-5 text-brand-500 group-hover:text-brand-400" />
            }
        ...
        <div className="mt-12 text-center reveal-on-scroll bg-brand-900/20 py-10 px-6 rounded-2xl border border-brand-700/20 backdrop-blur-sm max-w-3xl mx-auto">
          <h3 className="text-xl md:text-2xl font-display font-semibold mb-6 text-white">
